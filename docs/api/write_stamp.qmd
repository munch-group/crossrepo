# write_stamp { #labdata.manifest.write_stamp }

```python
labdata.manifest.write_stamp(text, key, stamp)
```
...
<code>[**stamp**]{.parameter-name} [:]{.parameter-annotation-sep} [[Stamp](`labdata.manifest.Stamp`)]{.parameter-annotation}</code>
